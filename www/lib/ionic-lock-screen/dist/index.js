  ...
  return {
    ...
    link: function (o) {
      ...
      o.enteredPasscode = "", o.$on("ionic-lock-screen:show", function (e, i) {
        ...
        o.selected = +i, o.passcodeWrong || (o.enteredPasscode += "" + i, o.enteredPasscode.length >= 4 && (md5(o.enteredPasscode) === "" + o.passcode ? (o.enteredPasscode = "", e = 0, o.onCorrect && o.onCorrect(), o._showLockScreen = !1) : (o.passcodeWrong = !0, e++, o.onWrong && o.onWrong(e), n(function () {
